...
@section('content')
    ...
    <section class="text-center">
        <h1 class="my-8 font-passero text-4xl md:text-6xl text-white">Recommended <span class="text-secondary">Tasty</span>
            Food !</h1>
                ...
                <div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
                    <div class="w-full h-64 rounded-lg shadow-md">
                        <img src={{ asset('storage/uploads/categories/' . $category->image) }}
                            class="rounded-lg w-full h-full" alt="category">
                    </div>
    ...
    <section class="w-full bg-transparent mt-12">
        ...
        <form action="{{ route('testimonials.store') }}" method="POST" class="max-w-screen-xl lg:my-auto lg:mx-auto mx-4">
            ...
            <div class="mb-5">
                <label for="inFavourOf" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chose either
                    it's QUICKBITE or a specific restaurant </label>
        ...
        <div class="max-w-screen-xl lg:mx-auto flex items-center justify-between my-12 mx-4">
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="flex flex-col justify-between items-start">
                    <p
                        class="text-sm lg:text-xl max-w-4xl font-extrabold font-poppins text-center text-neutral-100 uppercase">
                        Phone
                    </p>
                    <p class="text-sm lg:text-lg max-w-4xl font-bold font-poppins text-center text-secondary uppercase ">
                        +212
                        524646666</p>
                </div>
                ...
                <div class="flex flex-col-reverse items-end lg:flex-row gap-4">
                    <div class="flex flex-col justify-between items-end">
                        <p
                            ...
                            Email</p>
                        <p
                            class="text-sm lg:text-xl max-w-4xl font-bold font-poppins text-center text-secondary uppercase ">

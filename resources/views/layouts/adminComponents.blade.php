...
<header class=" mx-auto max-w-screen-xl">
    <nav class="fixed w-full max-w-screen-2xl ml-auto top-2 z-50 border-b border-gray-700 backdrop-blur-sm bg-black/40 rounded-2xl"
        data-te-navbar-ref>
...
{{-- Sidebar --}}
 ...
 <aside id="sidebar-multi-level-sidebar" class="fixed bottom-2 top-2 left-4  z-40 w-72  transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">

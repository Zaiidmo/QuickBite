                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ $user->created_at }}</td>
            ...
            <table class="w-full divide-y divide-gray-400 text-center">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ $customer->created_at }}</td>
                    ...
                    <tr>
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full border-2 border-secondary"
                                src={{ asset('assets/images/avatar.jpg') }} alt="Jese image">
                            <div class="ps-3 text-left">
                                <div class="text-base font-semibold">{{ $restaurant->username }}</div>
                    ...
                    <tr>
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full border-2 border-secondary"
                                src={{ asset('assets/images/avatar.jpg') }} alt="Jese image">
                            <div class="ps-3 text-left">
                                <div class="text-base font-semibold">{{ $rider->username }}</div>
                                <div class="font-normal text-gray-500">{{ $restaurant->email }}</div>
                            </div>
                        </th>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ $restaurant->created_at }}</td>

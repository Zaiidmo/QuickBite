    ...
    <section id="statistics">
        <div class="grid gap-6 mb-8 mx-4 md:grid-cols-2 lg:max-w-screen-2xl lg:ml-auto  lg:pr-16 xl:grid-cols-4">
            ...
            <div class="col-span-1 md:col-span-2">
                <canvas id="earnings_chart" class="w-full h-full rounded-lg backdrop-blur-xl bg-black/40 border-2 border-secondary text-white"></canvas>
            </div>
        </div>
    </section>
    <section id="statistics_tables" class="font-poppins mx-4 grid grid-cols-1 lg:grid-cols-3 gap-6 mt-16 lg:max-w-screen-2xl lg:mx-auto lg:pr-16 mb-24">
        ...
        <div class="col-span-3 grid grid-cols-4 gap-4">
            <div class="flex flex-col w-full backdrop-blur-sm  bg-black/40 border-2 border-secondary rounded-lg overflow-x-auto p-1.5 align-middle col-span-1">
                ...
                <div class="max-h-72 overflow-y-auto">
                    <table class="divide-y divide-gray-400">
                        <thead>
                            <tr>
                                <th scope="col" class="px-6 py-3 text-start text-xs font-extrabold text-gray-400 uppercase">Order N
                                </th>
                                <th scope="col" class="px-6 py-3 text-start text-xs font-extrabold text-gray-400 uppercase">By
                                </th>
                                <th scope="col" class="px-6 py-3 text-start text-xs font-extrabold text-gray-400 uppercase">Price
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="flex w-full h-full flex-col gap-4 col-span-1 md:col-span-2">
                <div class=" w-[100%]">
                    <canvas id="restau_chart" class="w-full font-passero h-full rounded-lg backdrop-blur-xl bg-black/40 border-2 border-secondary text-white"></canvas>
                </div>
                
            </div>

            <div class="flex flex-col w-full h-fit backdrop-blur-sm bg-black/40 border-2 border-secondary rounded-lg overflow-x-auto p-1.5 align-middle col-span-1">
                <h1 class="font-passero text-2xl text-white m-4">
                ...
                <table class="divide-y divide-gray-400">
                    <thead>
                        <tr>
                            <th scope="col" class="px-6 py-3 text-start text-xs font-extrabold text-gray-400 uppercase">Meal
                            </th>
                            <th scope="col" class="px-6 py-3 text-start text-xs font-extrabold text-gray-400 uppercase">Presented By
                            </th>
                            <th scope="col" class="px-6 py-3 text-start text-xs font-extrabold text-gray-400 uppercase">Purshased
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
